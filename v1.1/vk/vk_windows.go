...
func (g *Win32SurfaceCreateInfoKHR) toC(c *C.VkWin32SurfaceCreateInfoKHR, _sa *stackAllocator) {
	c.sType = g.sType()
	if g.Next != nil {
...
func (s *Win32SurfaceCreateInfoKHR) toCStructure(_sa *stackAllocator) unsafe.Pointer {
	c := (*C.VkWin32SurfaceCreateInfoKHR)(_sa.alloc(C.sizeof_VkWin32SurfaceCreateInfoKHR))
	s.toC(c, _sa)
...
func (p PFNCreateWin32SurfaceKHR) Call(instance Instance, createInfo *Win32SurfaceCreateInfoKHR, allocator *AllocationCallbacks, surface *SurfaceKHR) (_ret Result) {
	...
	if createInfo != nil {
		c.pCreateInfo = (*C.VkWin32SurfaceCreateInfoKHR)(_sa.alloc(C.sizeof_VkWin32SurfaceCreateInfoKHR))
