...
const (
	...
	VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES                    int = 1000120000
	...
	VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETER_FEATURES               int = 1000063000
	...
	VK_STRUCTURE_TYPE_MIR_SURFACE_CREATE_INFO_KHR                                  int = 1000007000
	...
	VK_STRUCTURE_TYPE_OBJECT_TABLE_CREATE_INFO_NVX                                 int = 1000086000
	VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NVX                     int = 1000086001
	VK_STRUCTURE_TYPE_CMD_PROCESS_COMMANDS_INFO_NVX                                int = 1000086002
	VK_STRUCTURE_TYPE_CMD_RESERVE_SPACE_FOR_COMMANDS_INFO_NVX                      int = 1000086003
	VK_STRUCTURE_TYPE_DEVICE_GENERATED_COMMANDS_LIMITS_NVX                         int = 1000086004
	VK_STRUCTURE_TYPE_DEVICE_GENERATED_COMMANDS_FEATURES_NVX                       int = 1000086005
	...
	VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2_KHR                                 int = 1000109000
	VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2_KHR                                   int = 1000109001
	VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2_KHR                                    int = 1000109002
	VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2_KHR                                     int = 1000109003
	VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2_KHR                                int = 1000109004
	VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO_KHR                                       int = 1000109005
	VK_STRUCTURE_TYPE_SUBPASS_END_INFO_KHR                                         int = 1000109006
	...
	VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES_EXT         int = 1000130000
	VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO_EXT                       int = 1000130001
	...
	VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO_KHR                            int = 1000147000
	...
	VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO_EXT          int = 1000161000
	VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES_EXT             int = 1000161001
	VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES_EXT           int = 1000161002
	VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO_EXT   int = 1000161003
	VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT_EXT  int = 1000161004
	VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT                 int = 1000174000
	VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES_KHR                    int = 1000177000
	...
	VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT          int = 1000190001
	...
	VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES_KHR                int = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES
	...
	VK_STRUCTURE_TYPE_BEGIN_RANGE                                                  int = VK_STRUCTURE_TYPE_APPLICATION_INFO
	VK_STRUCTURE_TYPE_END_RANGE                                                    int = VK_STRUCTURE_TYPE_LOADER_DEVICE_CREATE_INFO
	VK_STRUCTURE_TYPE_RANGE_SIZE                                                   int = (VK_STRUCTURE_TYPE_LOADER_DEVICE_CREATE_INFO - VK_STRUCTURE_TYPE_APPLICATION_INFO + 1)
	VK_STRUCTURE_TYPE_MAX_ENUM                                                     int = 2147483647
)
...
func (g *VkApplicationInfo) toC(c *C.VkApplicationInfo, _sa *stackAllocator) {
	c.sType = C.enumVkStructureTyp(g.sType)
	c.pNext = g.pNext
...
type VkSystemAllocationScop int
...
const (
	...
	VK_SYSTEM_ALLOCATION_SCOPE_BEGIN_RANGE int = VK_SYSTEM_ALLOCATION_SCOPE_COMMAND
	VK_SYSTEM_ALLOCATION_SCOPE_END_RANGE   int = VK_SYSTEM_ALLOCATION_SCOPE_INSTANCE
	VK_SYSTEM_ALLOCATION_SCOPE_RANGE_SIZE  int = (VK_SYSTEM_ALLOCATION_SCOPE_INSTANCE - VK_SYSTEM_ALLOCATION_SCOPE_COMMAND + 1)
	VK_SYSTEM_ALLOCATION_SCOPE_MAX_ENUM    int = 2147483647
)

func (p PFN_vkAllocationFunction) Call( unsafe.Pointer,  uint,  uint,  int) (_ret unsafe.Pointer) {
	var c struct {
			unsafe.Pointer
			C.size_t
			C.size_t
			C.enumVkSystemAllocationScop
		_ret unsafe.Pointer
	}
	c. =
	c. = C.size_t()
	c. = C.size_t()
	c. = C.enumVkSystemAllocationScop()
...
func (p PFN_vkReallocationFunction) Call( unsafe.Pointer,  unsafe.Pointer,  uint,  uint,  int) (_ret unsafe.Pointer) {
	var c struct {
			unsafe.Pointer
			unsafe.Pointer
			C.size_t
...
type VkInternalAllocationTyp int

const (
	VK_INTERNAL_ALLOCATION_TYPE_EXECUTABLE  int = 0
	VK_INTERNAL_ALLOCATION_TYPE_BEGIN_RANGE int = VK_INTERNAL_ALLOCATION_TYPE_EXECUTABLE
	VK_INTERNAL_ALLOCATION_TYPE_END_RANGE   int = VK_INTERNAL_ALLOCATION_TYPE_EXECUTABLE
	VK_INTERNAL_ALLOCATION_TYPE_RANGE_SIZE  int = (VK_INTERNAL_ALLOCATION_TYPE_EXECUTABLE - VK_INTERNAL_ALLOCATION_TYPE_EXECUTABLE + 1)
	VK_INTERNAL_ALLOCATION_TYPE_MAX_ENUM    int = 2147483647
)

func (p PFN_vkInternalAllocationNotification) Call( unsafe.Pointer,  uint,  int,  int) {
	var c struct {
		unsafe.Pointer
		C.size_t
		C.enumVkInternalAllocationTyp
		C.enumVkSystemAllocationScop
	}
	c. =
	c. = C.size_t()
	c. = C.enumVkInternalAllocationTyp()
	c. = C.enumVkSystemAllocationScop()
...
func (p PFN_vkInternalFreeNotification) Call( unsafe.Pointer,  uint,  int,  int) {
	var c struct {
		unsafe.Pointer
		C.size_t
		C.enumVkInternalAllocationTyp
...
const (
	...
	VK_RESULT_BEGIN_RANGE                int = VK_ERROR_FRAGMENTED_POOL
	VK_RESULT_END_RANGE                  int = VK_INCOMPLETE
	VK_RESULT_RANGE_SIZE                 int = (VK_INCOMPLETE - VK_ERROR_FRAGMENTED_POOL + 1)
	VK_RESULT_MAX_ENUM                   int = 2147483647
)

func vkCreateInstance(pCreateInfo *VkInstanceCreateInfo, pAllocator *VkAllocationCallbacks, pInstance *VkInstance) (_ret int) {
	var c struct {
...
func vkEnumeratePhysicalDevices(instance VkInstance, pPhysicalDeviceCount *uint32, pPhysicalDevices []VkPhysicalDevice) (_ret int) {
	var c struct {
		instance             C.VkInstance
...
const (
	...
	VK_FORMAT_BEGIN_RANGE                                    int = VK_FORMAT_UNDEFINED
	VK_FORMAT_END_RANGE                                      int = VK_FORMAT_ASTC_12x12_SRGB_BLOCK
	VK_FORMAT_RANGE_SIZE                                     int = (VK_FORMAT_ASTC_12x12_SRGB_BLOCK - VK_FORMAT_UNDEFINED + 1)
...
func vkGetPhysicalDeviceFormatProperties(physicalDevice VkPhysicalDevice, format int, pFormatProperties []VkFormatProperties) {
	var c struct {
		physicalDevice    C.VkPhysicalDevice
		format            C.VkFormat
...
const (
	...
	VK_IMAGE_TYPE_BEGIN_RANGE int = VK_IMAGE_TYPE_1D
	VK_IMAGE_TYPE_END_RANGE   int = VK_IMAGE_TYPE_3D
	VK_IMAGE_TYPE_RANGE_SIZE  int = (VK_IMAGE_TYPE_3D - VK_IMAGE_TYPE_1D + 1)
	VK_IMAGE_TYPE_MAX_ENUM    int = 2147483647
)
...
const (
	...
	VK_IMAGE_TILING_BEGIN_RANGE int = VK_IMAGE_TILING_OPTIMAL
	VK_IMAGE_TILING_END_RANGE   int = VK_IMAGE_TILING_LINEAR
	VK_IMAGE_TILING_RANGE_SIZE  int = (VK_IMAGE_TILING_LINEAR - VK_IMAGE_TILING_OPTIMAL + 1)
...
func vkGetPhysicalDeviceImageFormatProperties(physicalDevice VkPhysicalDevice, format int, type int, tiling int, usage VkImageUsageFlags, flags VkImageCreateFlags, pImageFormatProperties []VkImageFormatProperties) (_ret int) {
	var c struct {
		physicalDevice         C.VkPhysicalDevice
		format                 C.VkFormat
		type                   C.enumVkImageTyp
...
const (
	...
	VK_PHYSICAL_DEVICE_TYPE_BEGIN_RANGE    int = VK_PHYSICAL_DEVICE_TYPE_OTHER
	VK_PHYSICAL_DEVICE_TYPE_END_RANGE      int = VK_PHYSICAL_DEVICE_TYPE_CPU
	VK_PHYSICAL_DEVICE_TYPE_RANGE_SIZE     int = (VK_PHYSICAL_DEVICE_TYPE_CPU - VK_PHYSICAL_DEVICE_TYPE_OTHER + 1)
...
func (g *VkPhysicalDeviceProperties) toC(c *C.VkPhysicalDeviceProperties) {
	...
	c.deviceType = C.enumVkPhysicalDeviceTyp(g.deviceType)
...
func vkCreateDevice(physicalDevice VkPhysicalDevice, pCreateInfo *VkDeviceCreateInfo, pAllocator *VkAllocationCallbacks, pDevice *VkDevice) (_ret int) {
	var c struct {
		physicalDevice C.VkPhysicalDevice
...
func vkEnumerateInstanceExtensionProperties(pLayerName string, pPropertyCount *uint32, pProperties []VkExtensionProperties) (_ret int) {
	var c struct {
		pLayerName     *C.char
...
func vkEnumerateDeviceExtensionProperties(physicalDevice VkPhysicalDevice, pLayerName string, pPropertyCount *uint32, pProperties []VkExtensionProperties) (_ret int) {
	var c struct {
		physicalDevice C.VkPhysicalDevice
		pLayerName     *C.char
		pPropertyCount *C.uint32_t
...
func vkEnumerateInstanceLayerProperties(pPropertyCount *uint32, pProperties []VkLayerProperties) (_ret int) {
	var c struct {
		pPropertyCount *C.uint32_t
...
func vkEnumerateDeviceLayerProperties(physicalDevice VkPhysicalDevice, pPropertyCount *uint32, pProperties []VkLayerProperties) (_ret int) {
	var c struct {
		physicalDevice C.VkPhysicalDevice
		pPropertyCount *C.uint32_t
		pProperties    *C.VkLayerProperties
...
func vkQueueSubmit(queue VkQueue, pSubmits []VkSubmitInfo, fence VkFence) (_ret int) {
	var c struct {
		queue       C.VkQueue
...
func vkQueueWaitIdle(queue VkQueue) (_ret int) {
	var c struct {
		queue C.VkQueue
		_ret  C.VkResult
	}
...
func vkDeviceWaitIdle(device VkDevice) (_ret int) {
	var c struct {
		device C.VkDevice
		_ret   C.VkResult
	}
...
func vkAllocateMemory(device VkDevice, pAllocateInfo *VkMemoryAllocateInfo, pAllocator *VkAllocationCallbacks, pMemory *VkDeviceMemory) (_ret int) {
	var c struct {
		device        C.VkDevice
...
func vkMapMemory(device VkDevice, memory VkDeviceMemory, offset VkDeviceSize, size VkDeviceSize, flags VkMemoryMapFlags, ppData []unsafe.Pointer) (_ret int) {
	var c struct {
		device C.VkDevice
		memory C.VkDeviceMemory
...
func vkFlushMappedMemoryRanges(device VkDevice, pMemoryRanges []VkMappedMemoryRange) (_ret int) {
	var c struct {
		device           C.VkDevice
...
func vkInvalidateMappedMemoryRanges(device VkDevice, pMemoryRanges []VkMappedMemoryRange) (_ret int) {
	var c struct {
		device           C.VkDevice
		memoryRangeCount C.uint32_t
		pMemoryRanges    *C.VkMappedMemoryRange
...
func vkBindBufferMemory(device VkDevice, buffer VkBuffer, memory VkDeviceMemory, memoryOffset VkDeviceSize) (_ret int) {
	var c struct {
		device       C.VkDevice
		buffer       C.VkBuffer
		memory       C.VkDeviceMemory
...
func vkBindImageMemory(device VkDevice, image VkImage, memory VkDeviceMemory, memoryOffset VkDeviceSize) (_ret int) {
	var c struct {
		device       C.VkDevice
		image        C.VkImage
		memory       C.VkDeviceMemory
...
const (
	VK_SAMPLE_COUNT_1_BIT              int = 1
	VK_SAMPLE_COUNT_2_BIT              int = 2
	VK_SAMPLE_COUNT_4_BIT              int = 4
	VK_SAMPLE_COUNT_8_BIT              int = 8
	VK_SAMPLE_COUNT_16_BIT             int = 16
	VK_SAMPLE_COUNT_32_BIT             int = 32
	VK_SAMPLE_COUNT_64_BIT             int = 64
	VK_SAMPLE_COUNT_FLAG_BITS_MAX_ENUM int = 2147483647
)

func vkGetPhysicalDeviceSparseImageFormatProperties(physicalDevice VkPhysicalDevice, format int, type int, samples int, usage VkImageUsageFlags, tiling int, pPropertyCount *uint32, pProperties []VkSparseImageFormatProperties) {
	var c struct {
		physicalDevice C.VkPhysicalDevice
		format         C.VkFormat
		type           C.enumVkImageTyp
...
func vkQueueBindSparse(queue VkQueue, bindInfoCount uint32, pBindInfo *VkBindSparseInfo, fence VkFence) (_ret int) {
	var c struct {
		queue         C.VkQueue
...
func vkCreateFence(device VkDevice, pCreateInfo *VkFenceCreateInfo, pAllocator *VkAllocationCallbacks, pFence *VkFence) (_ret int) {
	var c struct {
		device      C.VkDevice
...
func vkResetFences(device VkDevice, pFences []VkFence) (_ret int) {
	var c struct {
		device     C.VkDevice
...
func vkGetFenceStatus(device VkDevice, fence VkFence) (_ret int) {
	var c struct {
		device C.VkDevice
		fence  C.VkFence
		_ret   C.VkResult
...
func vkWaitForFences(device VkDevice, pFences []VkFence, waitAll VkBool32, timeout uint64) (_ret int) {
	var c struct {
		device     C.VkDevice
		fenceCount C.uint32_t
		pFences    *C.VkFence
...
func vkCreateSemaphore(device VkDevice, pCreateInfo *VkSemaphoreCreateInfo, pAllocator *VkAllocationCallbacks, pSemaphore *VkSemaphore) (_ret int) {
	var c struct {
		device      C.VkDevice
...
func vkCreateEvent(device VkDevice, pCreateInfo *VkEventCreateInfo, pAllocator *VkAllocationCallbacks, pEvent *VkEvent) (_ret int) {
	var c struct {
		device      C.VkDevice
...
func vkGetEventStatus(device VkDevice, event VkEvent) (_ret int) {
	var c struct {
		device C.VkDevice
		event  C.VkEvent
		_ret   C.VkResult
...
func vkSetEvent(device VkDevice, event VkEvent) (_ret int) {
	var c struct {
		device C.VkDevice
		event  C.VkEvent
		_ret   C.VkResult
...
func vkResetEvent(device VkDevice, event VkEvent) (_ret int) {
	var c struct {
		device C.VkDevice
		event  C.VkEvent
		_ret   C.VkResult
...
const (
	...
	VK_QUERY_TYPE_BEGIN_RANGE         int = VK_QUERY_TYPE_OCCLUSION
	VK_QUERY_TYPE_END_RANGE           int = VK_QUERY_TYPE_TIMESTAMP
	VK_QUERY_TYPE_RANGE_SIZE          int = (VK_QUERY_TYPE_TIMESTAMP - VK_QUERY_TYPE_OCCLUSION + 1)
...
func (g *VkQueryPoolCreateInfo) toC(c *C.VkQueryPoolCreateInfo) {
	...
	c.queryType = C.enumVkQueryTyp(g.queryType)
...
func vkCreateQueryPool(device VkDevice, pCreateInfo *VkQueryPoolCreateInfo, pAllocator *VkAllocationCallbacks, pQueryPool *VkQueryPool) (_ret int) {
	var c struct {
		device      C.VkDevice
...
func vkGetQueryPoolResults(device VkDevice, queryPool VkQueryPool, firstQuery uint32, queryCount uint32, pData []byte, stride VkDeviceSize, flags VkQueryResultFlags) (_ret int) {
	var c struct {
		device     C.VkDevice
		queryPool  C.VkQueryPool
...
type VkSharingMod int

const (
	VK_SHARING_MODE_EXCLUSIVE   int = 0
	VK_SHARING_MODE_CONCURRENT  int = 1
	VK_SHARING_MODE_BEGIN_RANGE int = VK_SHARING_MODE_EXCLUSIVE
	VK_SHARING_MODE_END_RANGE   int = VK_SHARING_MODE_CONCURRENT
	VK_SHARING_MODE_RANGE_SIZE  int = (VK_SHARING_MODE_CONCURRENT - VK_SHARING_MODE_EXCLUSIVE + 1)
...
func (g *VkBufferCreateInfo) toC(c *C.VkBufferCreateInfo, _sa *stackAllocator) {
	...
	c.sharingMode = C.enumVkSharingMod(g.sharingMode)
...
func (g *VkBufferCreateInfo) fromC(c *C.VkBufferCreateInfo) {
	...
	g.sharingMode = int(c.sharingMode)
...
func vkCreateBuffer(device VkDevice, pCreateInfo *VkBufferCreateInfo, pAllocator *VkAllocationCallbacks, pBuffer *VkBuffer) (_ret int) {
	var c struct {
		device      C.VkDevice
...
func vkCreateBufferView(device VkDevice, pCreateInfo *VkBufferViewCreateInfo, pAllocator *VkAllocationCallbacks, pView *VkBufferView) (_ret int) {
	var c struct {
		device      C.VkDevice
...
const (
	...
	VK_IMAGE_LAYOUT_BEGIN_RANGE                                    int = VK_IMAGE_LAYOUT_UNDEFINED
	VK_IMAGE_LAYOUT_END_RANGE                                      int = VK_IMAGE_LAYOUT_PREINITIALIZED
	VK_IMAGE_LAYOUT_RANGE_SIZE                                     int = (VK_IMAGE_LAYOUT_PREINITIALIZED - VK_IMAGE_LAYOUT_UNDEFINED + 1)
...
func (g *VkImageCreateInfo) toC(c *C.VkImageCreateInfo, _sa *stackAllocator) {
	...
	c.imageType = C.enumVkImageTyp(g.imageType)
	c.format = C.VkFormat(g.format)
	g.extent.toC(&c.extent)
...
func (g *VkImageCreateInfo) fromC(c *C.VkImageCreateInfo) {
	...
	g.imageType = int(c.imageType)
	g.format = int(c.format)
	g.extent.fromC(&c.extent)
	g.mipLevels = uint32(c.mipLevels)
	g.arrayLayers = uint32(c.arrayLayers)
	g.samples = int(c.samples)
	g.tiling = int(c.tiling)
	{
		var _temp VkFlags
		{
			var _temp uint32
	...
	g.initialLayout = int(c.initialLayout)
}
func vkCreateImage(device VkDevice, pCreateInfo *VkImageCreateInfo, pAllocator *VkAllocationCallbacks, pImage *VkImage) (_ret int) {
	var c struct {
		device      C.VkDevice
...
const (
	...
	VK_IMAGE_VIEW_TYPE_BEGIN_RANGE int = VK_IMAGE_VIEW_TYPE_1D
	VK_IMAGE_VIEW_TYPE_END_RANGE   int = VK_IMAGE_VIEW_TYPE_CUBE_ARRAY
	VK_IMAGE_VIEW_TYPE_RANGE_SIZE  int = (VK_IMAGE_VIEW_TYPE_CUBE_ARRAY - VK_IMAGE_VIEW_TYPE_1D + 1)
	VK_IMAGE_VIEW_TYPE_MAX_ENUM    int = 2147483647
)

type VkComponentSwizzl int
...
const (
	...
	VK_COMPONENT_SWIZZLE_BEGIN_RANGE int = VK_COMPONENT_SWIZZLE_IDENTITY
	VK_COMPONENT_SWIZZLE_END_RANGE   int = VK_COMPONENT_SWIZZLE_A
	VK_COMPONENT_SWIZZLE_RANGE_SIZE  int = (VK_COMPONENT_SWIZZLE_A - VK_COMPONENT_SWIZZLE_IDENTITY + 1)
	VK_COMPONENT_SWIZZLE_MAX_ENUM    int = 2147483647
)
...
func (g *VkComponentMapping) toC(c *C.VkComponentMapping) {
	c.r = C.enumVkComponentSwizzl(g.r)
	c.g = C.enumVkComponentSwizzl(g.g)
	c.b = C.enumVkComponentSwizzl(g.b)
	c.a = C.enumVkComponentSwizzl(g.a)
}
...
func (g *VkImageViewCreateInfo) toC(c *C.VkImageViewCreateInfo) {
	...
	c.image = C.VkImage(g.image)
	c.viewType = C.enumVkImageViewTyp(g.viewType)
	c.format = C.VkFormat(g.format)
...
func vkCreateImageView(device VkDevice, pCreateInfo *VkImageViewCreateInfo, pAllocator *VkAllocationCallbacks, pView *VkImageView) (_ret int) {
	var c struct {
		device      C.VkDevice
...
func vkCreateShaderModule(device VkDevice, pCreateInfo *VkShaderModuleCreateInfo, pAllocator *VkAllocationCallbacks, pShaderModule *VkShaderModule) (_ret int) {
	var c struct {
		device        C.VkDevice
...
func vkCreatePipelineCache(device VkDevice, pCreateInfo *VkPipelineCacheCreateInfo, pAllocator *VkAllocationCallbacks, pPipelineCache *VkPipelineCache) (_ret int) {
	var c struct {
		device         C.VkDevice
...
func vkGetPipelineCacheData(device VkDevice, pipelineCache VkPipelineCache, pDataSize *uint, pData []byte) (_ret int) {
	var c struct {
		device        C.VkDevice
		pipelineCache C.VkPipelineCache
		pDataSize     *C.size_t
...
func vkMergePipelineCaches(device VkDevice, dstCache VkPipelineCache, pSrcCaches []VkPipelineCache) (_ret int) {
	var c struct {
		device        C.VkDevice
...
const (
	VK_SHADER_STAGE_VERTEX_BIT                  int = 1
	VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT    int = 2
	VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT int = 4
	VK_SHADER_STAGE_GEOMETRY_BIT                int = 8
	VK_SHADER_STAGE_FRAGMENT_BIT                int = 16
	VK_SHADER_STAGE_COMPUTE_BIT                 int = 32
	VK_SHADER_STAGE_ALL_GRAPHICS                int = 31
	VK_SHADER_STAGE_ALL                         int = 2147483647
	VK_SHADER_STAGE_FLAG_BITS_MAX_ENUM          int = 2147483647
)
...
type VkVertexInputRat int

const (
	VK_VERTEX_INPUT_RATE_VERTEX      int = 0
	VK_VERTEX_INPUT_RATE_INSTANCE    int = 1
	VK_VERTEX_INPUT_RATE_BEGIN_RANGE int = VK_VERTEX_INPUT_RATE_VERTEX
	VK_VERTEX_INPUT_RATE_END_RANGE   int = VK_VERTEX_INPUT_RATE_INSTANCE
	VK_VERTEX_INPUT_RATE_RANGE_SIZE  int = (VK_VERTEX_INPUT_RATE_INSTANCE - VK_VERTEX_INPUT_RATE_VERTEX + 1)
	VK_VERTEX_INPUT_RATE_MAX_ENUM    int = 2147483647
)
...
func (g *VkVertexInputBindingDescription) toC(c *C.VkVertexInputBindingDescription) {
	...
	c.inputRate = C.enumVkVertexInputRat(g.inputRate)
}
...
const (
	...
	VK_PRIMITIVE_TOPOLOGY_BEGIN_RANGE                   int = VK_PRIMITIVE_TOPOLOGY_POINT_LIST
	VK_PRIMITIVE_TOPOLOGY_END_RANGE                     int = VK_PRIMITIVE_TOPOLOGY_PATCH_LIST
	VK_PRIMITIVE_TOPOLOGY_RANGE_SIZE                    int = (VK_PRIMITIVE_TOPOLOGY_PATCH_LIST - VK_PRIMITIVE_TOPOLOGY_POINT_LIST + 1)
...
const (
	...
	VK_POLYGON_MODE_BEGIN_RANGE       int = VK_POLYGON_MODE_FILL
	VK_POLYGON_MODE_END_RANGE         int = VK_POLYGON_MODE_POINT
	VK_POLYGON_MODE_RANGE_SIZE        int = (VK_POLYGON_MODE_POINT - VK_POLYGON_MODE_FILL + 1)
	VK_POLYGON_MODE_MAX_ENUM          int = 2147483647
)
...
const (
	...
	VK_FRONT_FACE_BEGIN_RANGE       int = VK_FRONT_FACE_COUNTER_CLOCKWISE
	VK_FRONT_FACE_END_RANGE         int = VK_FRONT_FACE_CLOCKWISE
	VK_FRONT_FACE_RANGE_SIZE        int = (VK_FRONT_FACE_CLOCKWISE - VK_FRONT_FACE_COUNTER_CLOCKWISE + 1)
	VK_FRONT_FACE_MAX_ENUM          int = 2147483647
)
...
func (g *VkPipelineRasterizationStateCreateInfo) toC(c *C.VkPipelineRasterizationStateCreateInfo) {
	...
	c.polygonMode = C.enumVkPolygonMod(g.polygonMode)
	{
		var _temp C.VkFlags
		{
			var _temp C.uint32_t
	...
	c.frontFace = C.enumVkFrontFac(g.frontFace)
	{
		var _temp C.uint32_t
...
func (g *VkPipelineRasterizationStateCreateInfo) fromC(c *C.VkPipelineRasterizationStateCreateInfo) {
	...
	g.polygonMode = int(c.polygonMode)
	{
		var _temp VkFlags
		{
			var _temp uint32
...
func (g *VkPipelineMultisampleStateCreateInfo) fromC(c *C.VkPipelineMultisampleStateCreateInfo) {
	...
	g.rasterizationSamples = int(c.rasterizationSamples)
	{
		var _temp uint32
...
const (
	...
	VK_COMPARE_OP_BEGIN_RANGE      int = VK_COMPARE_OP_NEVER
	VK_COMPARE_OP_END_RANGE        int = VK_COMPARE_OP_ALWAYS
	VK_COMPARE_OP_RANGE_SIZE       int = (VK_COMPARE_OP_ALWAYS - VK_COMPARE_OP_NEVER + 1)
...
const (
	...
	VK_STENCIL_OP_BEGIN_RANGE         int = VK_STENCIL_OP_KEEP
	VK_STENCIL_OP_END_RANGE           int = VK_STENCIL_OP_DECREMENT_AND_WRAP
	VK_STENCIL_OP_RANGE_SIZE          int = (VK_STENCIL_OP_DECREMENT_AND_WRAP - VK_STENCIL_OP_KEEP + 1)
...
func (g *VkStencilOpState) fromC(c *C.VkStencilOpState) {
	g.failOp = int(c.failOp)
	g.passOp = int(c.passOp)
	g.depthFailOp = int(c.depthFailOp)
	g.compareOp = int(c.compareOp)
...
func (g *VkPipelineDepthStencilStateCreateInfo) fromC(c *C.VkPipelineDepthStencilStateCreateInfo) {
	...
	g.depthCompareOp = int(c.depthCompareOp)
	{
		var _temp uint32
...
const (
	...
	VK_LOGIC_OP_BEGIN_RANGE   int = VK_LOGIC_OP_CLEAR
	VK_LOGIC_OP_END_RANGE     int = VK_LOGIC_OP_SET
	VK_LOGIC_OP_RANGE_SIZE    int = (VK_LOGIC_OP_SET - VK_LOGIC_OP_CLEAR + 1)
...
const (
	...
	VK_BLEND_FACTOR_BEGIN_RANGE              int = VK_BLEND_FACTOR_ZERO
	VK_BLEND_FACTOR_END_RANGE                int = VK_BLEND_FACTOR_ONE_MINUS_SRC1_ALPHA
	VK_BLEND_FACTOR_RANGE_SIZE               int = (VK_BLEND_FACTOR_ONE_MINUS_SRC1_ALPHA - VK_BLEND_FACTOR_ZERO + 1)
...
const (
	...
	VK_BLEND_OP_BEGIN_RANGE            int = VK_BLEND_OP_ADD
	VK_BLEND_OP_END_RANGE              int = VK_BLEND_OP_MAX
	VK_BLEND_OP_RANGE_SIZE             int = (VK_BLEND_OP_MAX - VK_BLEND_OP_ADD + 1)
...
func (g *VkPipelineColorBlendAttachmentState) fromC(c *C.VkPipelineColorBlendAttachmentState) {
	...
	g.srcColorBlendFactor = int(c.srcColorBlendFactor)
	g.dstColorBlendFactor = int(c.dstColorBlendFactor)
	g.colorBlendOp = int(c.colorBlendOp)
	g.srcAlphaBlendFactor = int(c.srcAlphaBlendFactor)
	g.dstAlphaBlendFactor = int(c.dstAlphaBlendFactor)
	g.alphaBlendOp = int(c.alphaBlendOp)
	{
		var _temp VkFlags
		{
			var _temp uint32
...
const (
	...
	VK_DYNAMIC_STATE_BEGIN_RANGE           int = VK_DYNAMIC_STATE_VIEWPORT
	VK_DYNAMIC_STATE_END_RANGE             int = VK_DYNAMIC_STATE_STENCIL_REFERENCE
	VK_DYNAMIC_STATE_RANGE_SIZE            int = (VK_DYNAMIC_STATE_STENCIL_REFERENCE - VK_DYNAMIC_STATE_VIEWPORT + 1)
...
func (g *VkPipelineDynamicStateCreateInfo) toC(c *C.VkPipelineDynamicStateCreateInfo, _sa *stackAllocator) {
	...
	{
		c.pDynamicStates = (*C.enumVkDynamicStat)(_sa.alloc(C.sizeof_enum_VkDynamicStat * uint(len(g.pDynamicStates))))
		slice2 := (*[1 << 31]C.enumVkDynamicStat)(unsafe.Pointer(c.pDynamicStates))[:len(g.pDynamicStates):len(g.pDynamicStates)]
		for i2, _ := range g.pDynamicStates {
			slice2[i2] = C.enumVkDynamicStat(g.pDynamicStates[i2])
		}
	}
}
func (g *VkPipelineDynamicStateCreateInfo) fromC(c *C.VkPipelineDynamicStateCreateInfo) {
	...
	g.pDynamicStates = make([]int, int(c.dynamicStateCount))
	{
		slice2 := (*[1 << 31]C.enumVkDynamicStat)(unsafe.Pointer(c.pDynamicStates))[:len(g.pDynamicStates):len(g.pDynamicStates)]
		for i2, _ := range g.pDynamicStates {
			g.pDynamicStates[i2] = int(slice2[i2])
		}
	}
}
...
func vkCreateGraphicsPipelines(device VkDevice, pipelineCache VkPipelineCache, pCreateInfos []VkGraphicsPipelineCreateInfo, pAllocator *VkAllocationCallbacks, pPipelines []VkPipeline) (_ret int) {
	var c struct {
		device          C.VkDevice
		pipelineCache   C.VkPipelineCache
...
func vkCreateComputePipelines(device VkDevice, pipelineCache VkPipelineCache, pCreateInfos []VkComputePipelineCreateInfo, pAllocator *VkAllocationCallbacks, pPipelines []VkPipeline) (_ret int) {
	var c struct {
		device          C.VkDevice
		pipelineCache   C.VkPipelineCache
		createInfoCount C.uint32_t
...
func vkCreatePipelineLayout(device VkDevice, pCreateInfo *VkPipelineLayoutCreateInfo, pAllocator *VkAllocationCallbacks, pPipelineLayout *VkPipelineLayout) (_ret int) {
	var c struct {
		device          C.VkDevice
...
const (
	...
	VK_FILTER_BEGIN_RANGE int = VK_FILTER_NEAREST
	VK_FILTER_END_RANGE   int = VK_FILTER_LINEAR
	VK_FILTER_RANGE_SIZE  int = (VK_FILTER_LINEAR - VK_FILTER_NEAREST + 1)
	VK_FILTER_MAX_ENUM    int = 2147483647
)

type VkSamplerMipmapMod int

const (
	VK_SAMPLER_MIPMAP_MODE_NEAREST     int = 0
	VK_SAMPLER_MIPMAP_MODE_LINEAR      int = 1
	VK_SAMPLER_MIPMAP_MODE_BEGIN_RANGE int = VK_SAMPLER_MIPMAP_MODE_NEAREST
	VK_SAMPLER_MIPMAP_MODE_END_RANGE   int = VK_SAMPLER_MIPMAP_MODE_LINEAR
	VK_SAMPLER_MIPMAP_MODE_RANGE_SIZE  int = (VK_SAMPLER_MIPMAP_MODE_LINEAR - VK_SAMPLER_MIPMAP_MODE_NEAREST + 1)
	VK_SAMPLER_MIPMAP_MODE_MAX_ENUM    int = 2147483647
)

type VkSamplerAddressMod int
...
const (
	...
	VK_SAMPLER_ADDRESS_MODE_BEGIN_RANGE          int = VK_SAMPLER_ADDRESS_MODE_REPEAT
	VK_SAMPLER_ADDRESS_MODE_END_RANGE            int = VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER
	VK_SAMPLER_ADDRESS_MODE_RANGE_SIZE           int = (VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER - VK_SAMPLER_ADDRESS_MODE_REPEAT + 1)
...
const (
	...
	VK_BORDER_COLOR_BEGIN_RANGE             int = VK_BORDER_COLOR_FLOAT_TRANSPARENT_BLACK
	VK_BORDER_COLOR_END_RANGE               int = VK_BORDER_COLOR_INT_OPAQUE_WHITE
	VK_BORDER_COLOR_RANGE_SIZE              int = (VK_BORDER_COLOR_INT_OPAQUE_WHITE - VK_BORDER_COLOR_FLOAT_TRANSPARENT_BLACK + 1)
...
func (g *VkSamplerCreateInfo) toC(c *C.VkSamplerCreateInfo) {
	...
	c.mipmapMode = C.enumVkSamplerMipmapMod(g.mipmapMode)
	c.addressModeU = C.enumVkSamplerAddressMod(g.addressModeU)
	c.addressModeV = C.enumVkSamplerAddressMod(g.addressModeV)
	c.addressModeW = C.enumVkSamplerAddressMod(g.addressModeW)
...
func (g *VkSamplerCreateInfo) fromC(c *C.VkSamplerCreateInfo) {
	...
	g.magFilter = int(c.magFilter)
	g.minFilter = int(c.minFilter)
	g.mipmapMode = int(c.mipmapMode)
	g.addressModeU = int(c.addressModeU)
	g.addressModeV = int(c.addressModeV)
	g.addressModeW = int(c.addressModeW)
	...
	g.borderColor = int(c.borderColor)
	{
		var _temp uint32
...
func vkCreateSampler(device VkDevice, pCreateInfo *VkSamplerCreateInfo, pAllocator *VkAllocationCallbacks, pSampler *VkSampler) (_ret int) {
	var c struct {
		device      C.VkDevice
...
const (
	...
	VK_DESCRIPTOR_TYPE_BEGIN_RANGE            int = VK_DESCRIPTOR_TYPE_SAMPLER
	VK_DESCRIPTOR_TYPE_END_RANGE              int = VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT
	VK_DESCRIPTOR_TYPE_RANGE_SIZE             int = (VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT - VK_DESCRIPTOR_TYPE_SAMPLER + 1)
...
func (g *VkDescriptorSetLayoutBinding) toC(c *C.VkDescriptorSetLayoutBinding, _sa *stackAllocator) {
	c.binding = C.uint32_t(g.binding)
	c.descriptorType = C.enumVkDescriptorTyp(g.descriptorType)
...
func (g *VkDescriptorSetLayoutBinding) fromC(c *C.VkDescriptorSetLayoutBinding) {
	g.binding = uint32(c.binding)
	g.descriptorType = int(c.descriptorType)
...
func vkCreateDescriptorSetLayout(device VkDevice, pCreateInfo *VkDescriptorSetLayoutCreateInfo, pAllocator *VkAllocationCallbacks, pSetLayout *VkDescriptorSetLayout) (_ret int) {
	var c struct {
		device      C.VkDevice
...
func (g *VkDescriptorPoolSize) toC(c *C.VkDescriptorPoolSize) {
	c.type = C.enumVkDescriptorTyp(g.type)
	c.descriptorCount = C.uint32_t(g.descriptorCount)
}
...
func vkCreateDescriptorPool(device VkDevice, pCreateInfo *VkDescriptorPoolCreateInfo, pAllocator *VkAllocationCallbacks, pDescriptorPool *VkDescriptorPool) (_ret int) {
	var c struct {
		device          C.VkDevice
...
func vkResetDescriptorPool(device VkDevice, descriptorPool VkDescriptorPool, flags VkDescriptorPoolResetFlags) (_ret int) {
	var c struct {
		device         C.VkDevice
		descriptorPool C.VkDescriptorPool
...
func vkAllocateDescriptorSets(device VkDevice, pAllocateInfo *VkDescriptorSetAllocateInfo, pDescriptorSets []VkDescriptorSet) (_ret int) {
	var c struct {
		device          C.VkDevice
...
func vkFreeDescriptorSets(device VkDevice, descriptorPool VkDescriptorPool, pDescriptorSets []VkDescriptorSet) (_ret int) {
	var c struct {
		device             C.VkDevice
		descriptorPool     C.VkDescriptorPool
...
func (g *VkDescriptorImageInfo) fromC(c *C.VkDescriptorImageInfo) {
	...
	g.imageLayout = int(c.imageLayout)
}
...
func vkCreateFramebuffer(device VkDevice, pCreateInfo *VkFramebufferCreateInfo, pAllocator *VkAllocationCallbacks, pFramebuffer *VkFramebuffer) (_ret int) {
	var c struct {
		device       C.VkDevice
...
const (
	...
	VK_ATTACHMENT_LOAD_OP_BEGIN_RANGE int = VK_ATTACHMENT_LOAD_OP_LOAD
	VK_ATTACHMENT_LOAD_OP_END_RANGE   int = VK_ATTACHMENT_LOAD_OP_DONT_CARE
	VK_ATTACHMENT_LOAD_OP_RANGE_SIZE  int = (VK_ATTACHMENT_LOAD_OP_DONT_CARE - VK_ATTACHMENT_LOAD_OP_LOAD + 1)
...
const (
	...
	VK_ATTACHMENT_STORE_OP_BEGIN_RANGE int = VK_ATTACHMENT_STORE_OP_STORE
	VK_ATTACHMENT_STORE_OP_END_RANGE   int = VK_ATTACHMENT_STORE_OP_DONT_CARE
	VK_ATTACHMENT_STORE_OP_RANGE_SIZE  int = (VK_ATTACHMENT_STORE_OP_DONT_CARE - VK_ATTACHMENT_STORE_OP_STORE + 1)
...
func (g *VkAttachmentDescription) fromC(c *C.VkAttachmentDescription) {
	...
	g.format = int(c.format)
	g.samples = int(c.samples)
	g.loadOp = int(c.loadOp)
	g.storeOp = int(c.storeOp)
	g.stencilLoadOp = int(c.stencilLoadOp)
	g.stencilStoreOp = int(c.stencilStoreOp)
	g.initialLayout = int(c.initialLayout)
	g.finalLayout = int(c.finalLayout)
}
...
const (
	...
	VK_PIPELINE_BIND_POINT_BEGIN_RANGE int = VK_PIPELINE_BIND_POINT_GRAPHICS
	VK_PIPELINE_BIND_POINT_END_RANGE   int = VK_PIPELINE_BIND_POINT_COMPUTE
	VK_PIPELINE_BIND_POINT_RANGE_SIZE  int = (VK_PIPELINE_BIND_POINT_COMPUTE - VK_PIPELINE_BIND_POINT_GRAPHICS + 1)
...
func (g *VkSubpassDescription) fromC(c *C.VkSubpassDescription) {
	...
	g.pipelineBindPoint = int(c.pipelineBindPoint)
...
func vkCreateRenderPass(device VkDevice, pCreateInfo *VkRenderPassCreateInfo, pAllocator *VkAllocationCallbacks, pRenderPass *VkRenderPass) (_ret int) {
	var c struct {
		device      C.VkDevice
...
func vkCreateCommandPool(device VkDevice, pCreateInfo *VkCommandPoolCreateInfo, pAllocator *VkAllocationCallbacks, pCommandPool *VkCommandPool) (_ret int) {
	var c struct {
		device       C.VkDevice
...
func vkResetCommandPool(device VkDevice, commandPool VkCommandPool, flags VkCommandPoolResetFlags) (_ret int) {
	var c struct {
		device      C.VkDevice
		commandPool C.VkCommandPool
...
const (
	...
	VK_COMMAND_BUFFER_LEVEL_BEGIN_RANGE int = VK_COMMAND_BUFFER_LEVEL_PRIMARY
	VK_COMMAND_BUFFER_LEVEL_END_RANGE   int = VK_COMMAND_BUFFER_LEVEL_SECONDARY
	VK_COMMAND_BUFFER_LEVEL_RANGE_SIZE  int = (VK_COMMAND_BUFFER_LEVEL_SECONDARY - VK_COMMAND_BUFFER_LEVEL_PRIMARY + 1)
...
func vkAllocateCommandBuffers(device VkDevice, pAllocateInfo *VkCommandBufferAllocateInfo, pCommandBuffers []VkCommandBuffer) (_ret int) {
	var c struct {
		device          C.VkDevice
...
func vkBeginCommandBuffer(commandBuffer VkCommandBuffer, pBeginInfo *VkCommandBufferBeginInfo) (_ret int) {
	var c struct {
...
func vkEndCommandBuffer(commandBuffer VkCommandBuffer) (_ret int) {
	var c struct {
		commandBuffer C.VkCommandBuffer
		_ret          C.VkResult
	}
...
func vkResetCommandBuffer(commandBuffer VkCommandBuffer, flags VkCommandBufferResetFlags) (_ret int) {
	var c struct {
		commandBuffer C.VkCommandBuffer
...
func vkCmdBindPipeline(commandBuffer VkCommandBuffer, pipelineBindPoint int, pipeline VkPipeline) {
	var c struct {
		commandBuffer     C.VkCommandBuffer
...
func vkCmdBindDescriptorSets(commandBuffer VkCommandBuffer, pipelineBindPoint int, layout VkPipelineLayout, firstSet uint32, pDescriptorSets []VkDescriptorSet, pDynamicOffsets []uint32) {
	var c struct {
		commandBuffer      C.VkCommandBuffer
		pipelineBindPoint  C.VkPipelineBindPoint
...
const (
	...
	VK_INDEX_TYPE_BEGIN_RANGE int = VK_INDEX_TYPE_UINT16
	VK_INDEX_TYPE_END_RANGE   int = VK_INDEX_TYPE_UINT32
	VK_INDEX_TYPE_RANGE_SIZE  int = (VK_INDEX_TYPE_UINT32 - VK_INDEX_TYPE_UINT16 + 1)
	VK_INDEX_TYPE_MAX_ENUM    int = 2147483647
)

func vkCmdBindIndexBuffer(commandBuffer VkCommandBuffer, buffer VkBuffer, offset VkDeviceSize, indexType int) {
	var c struct {
		commandBuffer C.VkCommandBuffer
		buffer        C.VkBuffer
		offset        C.VkDeviceSize
		indexType     C.enumVkIndexTyp
	}
	c.commandBuffer = C.VkCommandBuffer(commandBuffer)
	c.buffer = C.VkBuffer(buffer)
	{
	...
	c.indexType = C.enumVkIndexTyp(indexType)
...
func vkCmdCopyImage(commandBuffer VkCommandBuffer, srcImage VkImage, srcImageLayout int, dstImage VkImage, dstImageLayout int, pRegions []VkImageCopy) {
	var c struct {
		commandBuffer  C.VkCommandBuffer
		srcImage       C.VkImage
...
func vkCmdBlitImage(commandBuffer VkCommandBuffer, srcImage VkImage, srcImageLayout int, dstImage VkImage, dstImageLayout int, pRegions []VkImageBlit, filter int) {
	var c struct {
		commandBuffer  C.VkCommandBuffer
		srcImage       C.VkImage
		srcImageLayout C.VkImageLayout
...
func vkCmdCopyBufferToImage(commandBuffer VkCommandBuffer, srcBuffer VkBuffer, dstImage VkImage, dstImageLayout int, pRegions []VkBufferImageCopy) {
	var c struct {
		commandBuffer  C.VkCommandBuffer
		srcBuffer      C.VkBuffer
		dstImage       C.VkImage
...
func vkCmdCopyImageToBuffer(commandBuffer VkCommandBuffer, srcImage VkImage, srcImageLayout int, dstBuffer VkBuffer, pRegions []VkBufferImageCopy) {
	var c struct {
		commandBuffer  C.VkCommandBuffer
		srcImage       C.VkImage
		srcImageLayout C.VkImageLayout
